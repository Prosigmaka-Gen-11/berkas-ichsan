      ...
      return(
         ...
         <div className="flex justify-center ">
            <div className="w-1/3 p-10 drop-shadow-md">    
               <form>
                  <div className="mb-6">
                  <label for="nama" className="block mb-2 text-sm font-medium text-gray-900 dark:text-gray-300">Nama Lengkap {this.state.nama}</label>
                  ...
                  <div className="mb-6">
                  <label for="date" className="block mb-2 text-sm font-medium text-gray-900 dark:text-gray-300">Tanggal Lahir {this.state.date}</label>
                  ...
                  <div className="mb-6">  
                     <label for="date" className="block mb-2 text-sm font-medium text-gray-900 dark:text-gray-300">Jenis Kelamin {this.state.gender}</label>
                  ...
                  <label className="block mb-2 text-sm font-medium text-gray-900 dark:text-gray-300">Pekerjaan {this.state.job}</label>      
                     <div className="flex items-center mb-4">
                  ...
                  <div className="mb-6"> 
                  <label class="block mb-2 text-sm font-medium text-gray-900 dark:text-gray-400">Level {this.state.level}</label>
                  ...
                  <div className="mb-6">        
                  <label for="message" class="block mb-2 text-sm font-medium text-gray-900 dark:text-gray-400">Alamat {this.state.alamat}</label>
